...
extern void transform_sha256d64_sse41_4way(struct sha256* out, const struct sha256* in);
extern void transform_sha256multi_avx2_8way(struct sha256* out, const uint32_t* s, const unsigned char* in);
extern void transform_sha256d64_avx2_8way(struct sha256* out, const struct sha256* in);
extern void transform_sha256_shani(uint32_t* s, const unsigned char* chunk, size_t blocks);
extern void transform_sha256d64_shani_2way(struct sha256* out, const struct sha256* in);
#endif
#if defined(__arm__) || defined(__aarch32__) || defined(__arm64__) || defined(__aarch64__) || defined(_M_ARM)
extern void transform_sha256_armv8(uint32_t* s, const unsigned char* chunk, size_t blocks);
extern void transform_sha256d64_armv8_2way(struct sha256* out, const struct sha256* in);
#endif
